...
#define INTERVAL_DETECTOR_FROM_UDP 2
#define INTERVAL_DETECTOR_FROM_TCP 3
#define INTERVAL_DETECTOR_FROM_ICMP 4
#define INTERVAL_DETECTOR_FROM_OTHERS 5
#define INTERVAL_DETECTOR_TO_UDP 6
#define INTERVAL_DETECTOR_TO_TCP 7
#define INTERVAL_DETECTOR_TO_ICMP 8
#define INTERVAL_DETECTOR_TO_OTHERS 9
